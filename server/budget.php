...
<link href="./css/budget.css" media="all" rel="Stylesheet" type="text/css" />
...
$(document).ready(function() {
    $('.confirm_expenditure-form').submit(function(e) {
        e.preventDefault(); 
        var form = $(this);
        var formData = form.serialize(); 
        $.ajax({
...
document.querySelector(".confirm_expenditure-form").onclick = (e)=>{
